...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ortho_5x15(
        ...
        _______, KC_LEFT, KC_DOWN,  KC_RGHT, _______, _______, KC_BSLS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, UC(0x00E6), _______, _______, KC_INS,
        _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, UC(0x30C4), UC(0x40B), _______, _______, _______,
