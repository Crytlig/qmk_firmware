...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho_5x15(
        ...
        KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,     KC_G,    KC_SLSH, KC_H,     KC_J,  KC_K,     KC_L,    KC_QUOT, KC_ENT,  KC_ENT,  KC_RSFT,
    ...
    [2] = LAYOUT_ortho_5x15(
        _______,        UC_MOD,  _______,   _______, _______, _______, _______,      _______, _______, _______,     _______,    _______,    _______, _______, _______,
        _______,        RGB_TOG, RGB_MOD,   _______, _______, _______, _______,      _______, _______, _______,     _______,    XP(aa, AA), _______, _______, _______,
        KC_LCTL,        RGB_VAD, RGB_VAI,   _______, _______, _______, _______,      _______, _______, _______,     XP(ae, AE), XP(oe, OE), _______, _______, _______,
        _______,        _______, _______,   _______, _______, _______, KC_SCLN,      _______, X(SNEK), TD(TD_C_SC), _______,    _______,    _______, _______, _______,
